...
RESTful_Request::register_parser('application/x-www-form-urlencoded; charset=UTF-8', 'RESTful_Request_Parser_URLENC::parse'); //In order to make work HMVC requests
